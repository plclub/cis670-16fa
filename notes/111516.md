...
- Bob mentioned that the transitivity of Kleene equality follows from determinacy of evaluation.
  + Why does the transitivity rely on the determinacy?

  [SCW:  Say you know that    e1 ->* j /\  e2 ->*j   and e2 ->* k /\ e3 ->*k
